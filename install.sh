...
echo ""
echo "Docker runtime available too: build this repo and run container with --env-file and -v /opt/data:/opt/data."
echo "See docs/docker.md for full container instructions."
echo ""
